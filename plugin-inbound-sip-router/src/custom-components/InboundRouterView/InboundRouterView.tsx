...
import { loadConfig, publishConfig } from '../../utils/inbound-sip-router';

const InboundRouterView = ({}) => {
  const [ isLoading, setIsLoading ] = useState(true);
  const [ routes, setRoutes ] = useState([] as InboundSipRoute[]);
  ...
  const updateRoutes = (newRoutes: InboundSipRoute[]) => {
    setRoutes(newRoutes);
  }
