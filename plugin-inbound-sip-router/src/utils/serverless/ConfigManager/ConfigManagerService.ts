...
import { ListConfigResponse, UpdateConfigResponse, UpdateConfigStatusResponse, PublishConfigRequest, PublishConfigResponse } from '../../../types/config-manager';
import { EncodedParams } from '../../../types/serverless';
import ApiService from '../ApiService';

class ConfigService extends ApiService {

  async list(): Promise<ListConfigResponse | null> {
    try {
  ...
  async update(config: ListConfigResponse): Promise<UpdateConfigResponse> {
    try {
  ...
  #list = async () : Promise<ListConfigResponse> => {
    ...
    const response = await this.fetchJsonWithReject<ListConfigResponse>(
  ...
  #update = async (config: ListConfigResponse) : Promise<UpdateConfigResponse> => {
    const manager = Flex.Manager.getInstance();
