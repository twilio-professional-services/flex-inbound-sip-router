...
import { InboundSipRoute, InboundSipDefaultRoute } from '../../types/inbound-sip-router';
...
export const getDefaultRoute = (): InboundSipDefaultRoute => {
  return config.data.default;
}

export const updateDefaultRoute = (defaultRoute: InboundSipDefaultRoute) => {
  config.data.default = defaultRoute;
}

export const updateRouteData = (newRoute: InboundSipRoute | null, existingRoute: InboundSipRoute | null): InboundSipRoute[] => {
...
export const isRouteUnique = (newRoute: InboundSipRoute, existingRoute: InboundSipRoute | null): boolean => {
